...
export default function($) {
    ...
    $.Scalebar = function(options) {
        ...
        if(options.idDOM)document.getElementById(options.idDOM).appendChild(this.divElt);
        else this.viewer.container.appendChild(this.divElt);
    ...
    $.Scalebar.prototype = {
        ...
        getScalebarLocation: function() {
            var x,y,pixel,barWidth,barHeight,container
            ...
            if (this.location === $.ScalebarLocation.TOP_RIGHT) {
                barWidth = this.divElt.offsetWidth;
            ...
            if (this.location === $.ScalebarLocation.BOTTOM_RIGHT) {
                barWidth = this.divElt.offsetWidth;
                barHeight = this.divElt.offsetHeight;
                container = this.viewer.container;
                x = container.offsetWidth - barWidth;
